...
public class CategoriesMetier {

	//// sql database ::
	Transaction tx = null;	
	
	public CategoriesMetier() {
		super();
	...
	public void update(int matr,Categories newC) {
		// TODO Auto-generated method stub
	...
	public List<Categories> retreive() {
		// TODO Auto-generated method stub
		
		List<Categories> v = new ArrayList<Categories>();
		...
		try {
			...
			//ResultSet rs = Connexion.getCon().createStatement().executeQuery("Select * from client");
                    ...
                    v = session.createCriteria(Categories.class).list();
                    System.out.println("this is the first ::"+v.get(0).getLabel()+";");
                    tx.commit();
	...
	public Categories getCategoriesWithID(int mat) {
		// TODO Auto-generated method stub
		Categories c = null;
		try {
